...
*/
var id="ModalOverlay",overlay=null,showOverlay=function(){return overlay&&overlay.remove(),overlay=$('<div id="'+id+'"><div></div></div>'),overlay.bind("click",close),overlay.appendTo("body"),overlay},animate=function(a){a.addClass("ModalNone"),setTimeout(function(){a.addClass("ModalZoom"),setTimeout(function(){a.addClass("ModalNormal"),setTimeout(function(){a.removeClass("ModalZoom"),a.removeClass("ModalNone"),a.removeClass("ModalNormal")},500)},300)},50)},showInline=function(a){var b=showOverlay();b.css("opacity","1");var c=$(window).height(),d=$(window).width();a.show().css({"z-index":1001,position:"fixed",top:(c-a.height())/2,left:(d-a.width())/2}),animate(a),$("body").one("modalClose",function(){a.hide()})},showiFrame=function(a){var b=a.attr("href"),c=$("<iframe/>").attr("src",b).css("border",0);if(a.attr("data-modal-size")){var d=a.attr("data-modal-size").split("x");c.css({width:d[0],height:d[1]})}$("body").append(c),showInline(c)},show=function(a){var b=$(a.target),c=b.attr("data-modal");if(c=="inline"){var d=$(b.attr("data-modal-container"));showInline(d)}else c=="iframe"&&showiFrame(b);return window.location.hash="#modal",!1},close=function(){window.location.hash="",overlay.remove(),$("body").trigger("modalClose")},attach=function(a){a.bind("click",show)};$(function(){attach($("[data-modal]")),$("body").delegate("[data-modal-close]","click",close)});var modal={attach:attach,close:close}